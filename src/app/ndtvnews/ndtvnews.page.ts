...
@Component({
  selector: 'app-ndtvnews',
  templateUrl: './ndtvnews.page.html',
  styleUrls: ['./ndtvnews.page.scss'],
})
export class NdtvnewsPage implements OnInit {
  constructor(
  ...
  public async getData(pageNumber, event?) {
    ...
    await this.news.getNdtvNews(pageNumber).then((data) => {
