...
@Component({
  selector: 'app-indiatoday',
  templateUrl: './indiatoday.page.html',
  styleUrls: ['./indiatoday.page.scss'],
})
export class IndiatodayPage implements OnInit {
  ...
  public async getData(pageNumber, event?) {
    ...
    await this.news.getInNews(pageNumber).then((data) => {
